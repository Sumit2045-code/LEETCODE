class Solution {
    ...
    public void randomConnections(Node head1, Node head2) {
        ...
        while(temp1!=null && temp2!=null){
            ...
            else temp2.random = temp1.random.next; // main chiz
    ...
    public void split(Node head1) {
        ...
        Node temp2 = dummy2;
        Node temp = head1;// merged list pe taverse kr rha hai
        while(temp!=null){
            temp1.next = temp;
            temp=temp.next;
            temp1=temp1.next;
    ...
    public Node copyRandomList(Node head1) {
        // STEP 1 : Creating deep copy without random pointers 
        Node head2 = deepCopy(head1);
        // STEP 2 : Alternatively collecting lists 
        merge(head1,head2);
        // STEP 3 : Assigning random pointers 
        randomConnections(head1,head2);
        // STEP 4 : Splitting the combined list 
        split(head1);
        return head2;
    }
}